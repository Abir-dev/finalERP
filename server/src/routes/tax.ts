...
router.delete('/taxes/:id', authenticateUser, checkRole('admin'), taxController.deleteTax);
...
router.delete('/tax-charges/:id', authenticateUser, checkRole('admin'), taxController.deleteTaxCharge);
