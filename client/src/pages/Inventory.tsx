                        ...
                        <div className="flex items-center justify-between pt-2 border-t">
                          ...
                          <div className="flex gap-2">
                            <Button
                              ...
                              variant="outline"
                              onClick={() => {
                                setSelectedMaterialIndent(indent);
                                setIsViewMaterialIndentOpen(true);
                              }}
                            >
          ...
          {selectedMaterialIndent && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pb-4 border-b">
                <div>
                  <p className="text-xs text-muted-foreground">Indent No.</p>
                  <p className="font-semibold text-lg">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Indent Date</p>
                  <p className="font-semibold">
                    {new Date(
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pb-4 border-b">
                <div>
                  <p className="text-xs text-muted-foreground">WBS No.</p>
                  <p className="font-semibold">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                ...
                <div>
                  ...
                  <Badge
                    variant={
                      selectedMaterialIndent.status === "Pending"
                        ? "secondary"
                        : selectedMaterialIndent.status === "Approved"
                        ? "default"
                        : "outline"
                    }
                  >
